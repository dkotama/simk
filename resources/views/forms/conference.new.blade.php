          <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.conf.post') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="{{ isset($edited['name']) ? $edited['name'] : old('name') }}">
                        ...
                        <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="url" value="{{ isset($edited['url']) ? $edited['url'] : old('url') }}">
                        ...
                        <div class="form-group{{ $errors->has('start_conference') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="start_conference" value="">
